...
// ========== MODERN CHAIR ==========
const chairMat = mat(0x3366AA);
const chairLegMat = mat(0x888888);

// Seat
const seat = new THREE.Mesh(new THREE.BoxGeometry(1.0, 0.15, 1.0), chairMat);
seat.position.set(-3.5, 0.55, -1);
seat.castShadow = true;
scene.add(seat);

// Back rest
const backrest = new THREE.Mesh(new THREE.BoxGeometry(1.0, 1.0, 0.12), chairMat);
backrest.position.set(-3.5, 1.1, -1.45);
...
// Armrests
const armGeo = new THREE.BoxGeometry(0.1, 0.08, 0.8);
const armL = new THREE.Mesh(armGeo, chairLegMat);
armL.position.set(-3.95, 0.75, -1.0);
scene.add(armL);
const armR = new THREE.Mesh(armGeo, chairLegMat);
armR.position.set(-3.05, 0.75, -1.0);
scene.add(armR);
...
const colliders = [
  ...
  // Chair
  { min: new THREE.Vector3(-4.1, 0, -1.6), max: new THREE.Vector3(-2.9, 1.2, -0.5) },
];
